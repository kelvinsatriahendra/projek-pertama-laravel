        ...
        <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
            @foreach ($category->news as $news)
                <a href="{{ route('news.show', $news->slug) }}">
                    <div class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition"
                        style="height: 100%;">
                        <div>
                            <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolu">
